...
public class Event {
    ...
    //EFFECTS: overrides equals to only match for date and description
    @Override
    ...
    //EFFECTS: overrides hash to return unique hash for equal objects
    @Override
    public int hashCode() {
        return (HASH_CONSTANT * dateLogged.hashCode() + description.hashCode());
    }

    //EFFECTS: overrides toString() to ensure each date is printed on a new line
    @Override
